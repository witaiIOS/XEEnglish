...
@implementation PhotoInTheMonthCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.button1 = [PhotoInTheMonthButton buttonWithType:UIButtonTypeCustom];
        ...
        self.button2 =[PhotoInTheMonthButton buttonWithType:UIButtonTypeCustom];
        ...
        self.button3 =[PhotoInTheMonthButton buttonWithType:UIButtonTypeCustom];
